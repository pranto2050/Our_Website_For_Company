            ...
            >
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <span className="inline-flex items-center gap-2 text-accent font-medium opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-0 group-hover:translate-x-2">
